...
<head>
    ...
    <title>🧠 LocalMind - Personal Knowledge Assistant</title>
...
<body class="gradient-bg min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="text-center mb-8">
            <h1 class="text-5xl font-bold text-white mb-2">🧠 LocalMind</h1>
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow-xl p-6">
                <h3 class="text-xl font-bold mb-4 text-gray-800">📄 Document Upload</h3>
                <div 
                    id="uploadArea"
            ...
            <!-- Smart Search Info -->
            <div class="bg-white rounded-xl shadow-xl p-6">
                <h3 class="text-xl font-bold mb-4 text-gray-800">🔍 Smart Search</h3>
            ...
            <!-- Recent Documents -->
            <div class="bg-white rounded-xl shadow-xl p-6">
                <h3 class="text-xl font-bold mb-4 text-gray-800">📚 Recent Documents</h3>
            ...
            for (let file of files) {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        showStatus(`❌ Failed: ${file.name} - ${error.detail}`, 'error');
                    }
                } catch (error) {
